...
checkBranch9 = Checkbutton(tabBranch, text=val9[1], variable=checkState9)
...
checkBranch10 = Checkbutton(tabBranch, text=val10[1], variable=checkState10)
...
buttonFile.grid(column=3, row=2, sticky=E)
...
file.grid(column=1, row=2, pady=5, padx=5, sticky=W)
filePath.set(pVal)
